<?php require_once "system/common_admin.php";
    ...
    // ホワイトリスト変数の作成
    $whitelist = array("send", "no", "category", "title", "content");
        ...
        <h4 class="ml-20 mt-3">新しい記事の入力確認</h4>
            ...
            <div class="contact-content-1 ml-20 mt-3">
                ...
                <dl class="contact-dl">
                    ...
                    <dd class="contact-input-3 con-input-1 mb--3">
                ...
                <div class="mt-10">
                    <a href="confirm-fin_myworks-post.php" class="btn btn-outline-primary mt-3 ml-3">投稿</a>
                </div><!-- /contact-send -->
